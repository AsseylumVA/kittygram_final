...
DB_PORT=5432
DJANGO_SECRET=django-insecure-cg6*%6d51ef8f#4!r3*$vmxm4)abgjw8mo!4y-q*uq1!4$-89$
DEBUG=False
# Сохраняем файл. Ключ DJANGO_SECRET рекомендуется заменить
...
* [AsseylumVA](https://github.com/asseylumva)